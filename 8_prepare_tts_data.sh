...
htk/HVite34 -l '*' -a -b silence -m -I mlf/tts_words.mlf -H hmm/hmm15/macros -H hmm/hmm15/hmmdefs -i mlf/force_aligned.out txt/srcDict.txt phones/tiedlist -S txt/tts_mfc.scp
